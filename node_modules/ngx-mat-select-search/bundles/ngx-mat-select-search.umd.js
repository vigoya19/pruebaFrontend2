(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/forms'), require('@angular/cdk/keycodes'), require('@angular/animations'), require('@angular/cdk/scrolling'), require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('@angular/material'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ngx-mat-select-search', ['exports', '@angular/forms', '@angular/cdk/keycodes', '@angular/animations', '@angular/cdk/scrolling', 'rxjs', 'rxjs/operators', '@angular/core', '@angular/material', '@angular/common'], factory) :
    (factory((global['ngx-mat-select-search'] = {}),global.ng.forms,global.ng.cdk.keycodes,global.ng.animations,global.ng.cdk.scrolling,global.rxjs,global.rxjs.operators,global.ng.core,global.ng.material,global.ng.common));
}(this, (function (exports,forms,keycodes,animations,scrolling,rxjs,operators,core,material,common) { 'use strict';
    ...
    var MatSelectSearchComponent = /** @class */ (function () {
         ...
         */
            function () {
                if (this.matSelect.panel && this.matSelect.options.length > 0) {
                    ...
                    /** @type {?} */
                    var labelCount = material._countGroupLabelsBeforeOption(activeOptionIndex, this.matSelect.options, this.matSelect.optionGroups);
                    ...
                    /** @type {?} */
                    var amountOfVisibleOptions = Math.floor((material.SELECT_PANEL_MAX_HEIGHT - searchInputHeight) / matOptionHeight);
                    /** @type {?} */
                    ...
                    if (indexOfFirstVisibleOption >= indexOfOptionToFitIntoView) {
                        ...
                        this.matSelect.panel.nativeElement.scrollTop = (indexOfOptionToFitIntoView + 1) * matOptionHeight - (material.SELECT_PANEL_MAX_HEIGHT - searchInputHeight);
                    }
                }
            };
        /**
                        ...
                        animations: [
                            animations.trigger('enterAnimation', [
                                ...
                                animations.transition('void <=> *', [
                                    animations.animate('0.1s ease-out')
                                ])
                            ])
                        ],
        ...
        MatSelectSearchComponent.propDecorators = {
            ...
            preventHomeEndKeyPropagation: [{ type: core.Input }],
            disableScrollToActiveOnOptionsChanged: [{ type: core.Input }],
     ...
     */
    /** @type {?} */
    var MatSelectSearchVersion = '1.7.4';
